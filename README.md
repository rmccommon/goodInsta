...
1.The post uploading process takes a couple seconds but it does work. I could've probably imporoved by puting in a loading circle with it but I'm runing out of time I can put into this.

2.The actual instgram login screen probably uses a nice background image but its mostly just red so thats what I did.

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://image.ibb.co/eA4YeU/insta_Walkthrough.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
